...
def g_c_eval(population, nas, output_path, population_size, isl, gen):
    ...
    ranking_population = sorted(sample)
    ...
    # evolve
    print('evolve.....')
    print('old+offsprings size %d' % (len(population)))
...
def ga_c(cycles, population_size, output_path, from_path):
    ...
    while len(nas1.history) < cycles or len(nas2.history) < cycles :
        ...
        #     population1 = sorted(population1)
        #     population2 = sorted(population2)

        #     best1 = population1[-2:]
        #     best2 = population2[-2:]

        #     # validate
        #     if(best1[1].accuracy != max(population1).accuracy):
        #         print("b1 ne max(pop1)")
        #         print(best1[1].accuracy)
        #         print(max(population1).accuracy)
        #         exit()

        #     for i in range(2):
        #         population1.pop(np.random.randint(len(population1)))
        #         population2.pop(np.random.randint(len(population2)))

        #     for b in best1:
        #         population2.append(b)

        #     for b in best2:
        #         population1.append(b)
...
output_path = os.path.join(args.output_path, "ga-c-nom")
